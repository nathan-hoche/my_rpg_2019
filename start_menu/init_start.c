...
{
    start->menu_buttons[0].sprite = make_sprite(page->button_1);
    start->menu_buttons[1].sprite = make_sprite(page->button_1);
    start->menu_buttons[2].sprite = make_sprite(page->button_1);
    start->menu_buttons[3].sprite = make_sprite(page->button_1);
    start->menu_buttons[0].sp_rect = \
        (sfIntRect) {0, 0, BUT_1_SIZ_X, BUT_1_SIZ_Y};
    start->menu_buttons[1].sp_rect = \
        (sfIntRect) {0, 0, BUT_1_SIZ_X, BUT_1_SIZ_Y};
    start->menu_buttons[2].sp_rect = \
        (sfIntRect) {0, 0, BUT_1_SIZ_X, BUT_1_SIZ_Y};
    start->menu_buttons[3].sp_rect = \
        (sfIntRect) {0, 0, BUT_1_SIZ_X, BUT_1_SIZ_Y};
}
