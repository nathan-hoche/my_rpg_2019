...
{
    char *hp_play = my_getstr(player->hp);
    char *atk_play = my_getstr(player->atk);
    char *armor_play = my_getstr(player->armor);
    char *hp_enem = my_getstr(enemy->hp);
    char *atk_enem = my_getstr(enemy->atk);
    char *armor_enem = my_getstr(enemy->armor);
