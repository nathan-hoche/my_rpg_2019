...
{
    int blocks[25][2] = {{0, 0}, {0, 32}, {32, 32}, {32, 64}, {0, 64}, \
    {0, 4 * 32}, {32, 32 * 4}, {7 * 32, 0}, {5 * 32, 0}, {6 * 32, 0}, \
    {0, 5 * 32}, {0, 6 * 32}, {4 * 32, 21 * 32}, {6 * 32, 113 * 32}, \
    {6 * 32, 114 * 32}, {6 * 32, 115 * 32}, {32, 45 * 32}, {7 * 32, 44 * \
    32}, {7 * 32, 45 * 32}, {3 * 32, 109 * 32}, {2 * 32, 109 * 32}, {32, \
    109 * 32}, {0, 109 * 32}, {3 * 32, 113 * 32}, {3 * 32, 114 * 32}};
